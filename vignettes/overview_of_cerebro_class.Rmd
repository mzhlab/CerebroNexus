---
title: "Overview of the Cerebro class"
author: "Roman Hillje"
...
The `Cerebro` data class formalizes the data structure to provide stability and improve backward compatibility across CerebroNexus releases.
